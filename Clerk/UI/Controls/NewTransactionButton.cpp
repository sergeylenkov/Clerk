...
NewTransactionButton::NewTransactionButton(wxWindow* parent, CommandsInvoker& commandsInvoker, Icons& icons) : DropDownButton(parent, wxID_ANY, wxT("Add Transaction"), wxDefaultPosition, wxDefaultSize),
