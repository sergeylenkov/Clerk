...
TabsContextMenu::TabsContextMenu(int tabId, bool isLeftEnabled, bool isRightEnabled, bool isCloseEnabled):
	...
	wxMenuItem* item = this->Append(static_cast<int>(TabsContextMenuType::Left), wxT("Move to Left"));
	item->SetBitmap(wxBitmap(wxT("ICON_ARROW_LEFT"), wxBITMAP_TYPE_PNG_RESOURCE));
	...
	item = this->Append(static_cast<int>(TabsContextMenuType::Right), wxT("Move to Right"));	
	item->SetBitmap(wxBitmap(wxT("ICON_ARROW_RIGHT"), wxBITMAP_TYPE_PNG_RESOURCE));
	...
	item = this->Append(static_cast<int>(TabsContextMenuType::Close), wxT("Close"));
	item->SetBitmap(wxBitmap(wxT("ICON_CLOSE_TAB"), wxBITMAP_TYPE_PNG_RESOURCE));
